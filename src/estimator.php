...
function covid19ImpactEstimator($data)
{
    ...
    $estimate = '{data:{region: {name: '.$stats["region"]["name"].',avgAge: '.$stats["region"]["avgAge"].',avgDailyIncomeInUSD: '.$stats["region"]["avgDailyIncomeInUSD"].',avgDailyIncomePopulation: '.$stats["region"]["avgDailyIncomePopulation"].',},periodType: '.$stats["periodType"].',timeToElapse: '.$stats["timeToElapse"].',reportedCases: '.$stats["reportedCases"].',population: '.$stats["population"].',totalHospitalBeds: '.$stats["totalHospitalBeds"].',},impact: {currentlyInfected: '.$impactCurrentlyInfected.',infectionsByRequestedTime: '.$impactInfectionsByRequestedTime.',severeCasesByRequestedTime: '.$impactSevereCasesByRequestedTime.',hospitalBedsByRequestedTime: '.$impactHospitalBedsByRequestedTime.',casesForICUByRequestedTime: '.$impactCasesForICUByRequestedTime.',casesForVentilatorsByRequestedTime: '.$impactCasesForVentilatorsByRequestedTime.',dollarsInFlight: '.$impactDollarsInFlight.'},severeImpact: {currentlyInfected: '.$severeImpactCurrentlyInfected.',infectionsByRequestedTime: '.$severeImpactInfectionsByRequestedTime.',severeCasesByRequestedTime: '.$severeImpactSevereCasesByRequestedTime.',hospitalBedsByRequestedTime: '.$severeImpactHospitalBedsByRequestedTime.',casesForICUByRequestedTime: '.$severeImpactCasesForICUByRequestedTime.',casesForVentilatorsByRequestedTime: '.$severeImpactCasesForVentilatorsByRequestedTime.',dollarsInFlight: '.$severeImpactDollarsInFlight.'}}';
    $estimate = json_encode($estimate, JSON_PRETTY_PRINT);
    return $estimate;
}
